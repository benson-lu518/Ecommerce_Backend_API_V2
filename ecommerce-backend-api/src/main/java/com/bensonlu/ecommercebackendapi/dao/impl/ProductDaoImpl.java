...
public class ProductDaoImpl implements ProductDao {
    ...
    public Integer countProduct(ProductQueryParams productQueryParams) {
        ...
        Integer total=namedParameterJdbcTemplate.queryForObject(sql,map,Integer.class); //count to integer
        return total;
    }
    ...
    public Integer createProduct(ProductRequest productRequest) {
        ...
        int productId=keyHolder.getKey().intValue(); //get auto increment value
    ...
    public void updateStock(Integer productId, Integer stock) {
        //update stock and lastModifiedDate
    ...
    //conditional query: category and string search
